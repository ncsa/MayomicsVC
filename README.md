...
This workflow requires the following tools to be installed in order to run the workflow, (1) Cromwell-34, (2) Java-1.8, and (3) Python-3.6.1. After installation, set the respective executable tool to the environmental $PATH
