...
task ReadMappingTask {
   ...
   String BWA                      # Path to BWA MEM Tool
   ...
   command {
      ...
      then
         /bin/bash ${Bash_Script} ${SE} ${Is_Single_End} ${r} ${Input_Read1} ${R} ${Input_Read2} ${s} ${sampleName} ${G} ${RefFasta} ${O} ${OutDir} ${B} ${BWA} ${T} ${SAMTOOLS} ${t} ${Threads} ${e} ${Error_Logs}

      else
         /bin/bash ${Bash_Script} ${SE} ${Is_Single_End} ${r} ${Input_Read1} ${s} ${sampleName} ${G} ${RefFasta} ${O} ${OutDir} ${B} ${BWA} ${T} ${SAMTOOLS} ${t} ${Threads} ${e} ${Error_Logs}
      fi
