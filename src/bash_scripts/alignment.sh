...
#############################################################################
 ...
 EXAMPLES:
 alignment.sh -h
 alignment.sh -s sample -p platform -l read1.fq -r read2.fq -G reference.fa -K 10000000 -o "'-M'" -S /path/to/sentieon_directory -t 12 -P true -e /path/to/env_profile_file -d
...
while getopts ":hs:p:l:r:G:K:o:S:t:P:e:d" OPT
do
        case ${OPT} in
