...
# 
# Usage:
# realignment.sh -s <sample_name> -b <deduped_bam> -G <reference_genome> -k <known_sites> -O <output_directory> -S </path/to/Sentieon> -t <threads> -e </path/to/error_log> -d set_debug_mode [false]
#
################################################################################################################################
